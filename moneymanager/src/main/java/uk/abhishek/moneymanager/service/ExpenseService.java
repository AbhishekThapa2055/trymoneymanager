...
public class ExpenseService {
    ...
    public ExpenseDTO addExpense(ExpenseDTO dto)
    {
        ...
        ExpenseEntity expenseEntity = toEntity(dto,category,profile);
        expenseEntity  = expenseRepository.save(expenseEntity);
        return toDTO(expenseEntity);

    }

//Reterives all expenses for current month/based on the start date and end date
...
{
ProfileEntity profile  = profileService.getCurrentProfile();
BigDecimal total = expenseRepository.getTotalExpenseByProfileId(profile.getId());
